...
const CGFloat DatePickerHeaderTextSize = 12.0f;

@implementation HNADatePIckerHeaderView
...
- (id)initWithFrame:(CGRect)frame
{
    ...
    if (self) {
        ...
        [_titleLabel setFont:[UIFont systemFontOfSize:DatePickerHeaderTextSize]];
